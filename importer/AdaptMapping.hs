...
rawAdaptionTable = [(Haskell "Prelude.Bool" Type "Prelude.Bool", Isabelle "bool" Type "bool"),
  ...
  (Haskell "Prelude.+" Function "'a => 'a => 'a", Isabelle "HOL.plus_class.plus" Function "'a => 'a => 'a"),
  (Haskell "Prelude.-" Function "'a => 'a => 'a", Isabelle "HOL.minus_class.minus" Function "'a => 'a => 'a"),
  (Haskell "Prelude.<=" Function "'a => 'a => bool", Isabelle "HOL.ord_class.less_eq" Function "'a => 'a => bool"),
  (Haskell "Prelude.<" Function "'a => 'a => bool", Isabelle "HOL.ord_class.less" Function "'a => 'a => bool"),
